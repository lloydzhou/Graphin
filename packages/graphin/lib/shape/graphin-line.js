...
exports.default = exports.EnumNodeAndEdgeStatus = void 0;
exports.parseHalo = parseHalo;
exports.parseKeyShape = parseKeyShape;
...
var getStyleByTheme = function getStyleByTheme() {
  ...
  var themeResult = (0, _theme2.getDefaultStyleByTheme)(theme);
...
var EnumNodeAndEdgeStatus;
exports.EnumNodeAndEdgeStatus = EnumNodeAndEdgeStatus;
...
})(EnumNodeAndEdgeStatus || (exports.EnumNodeAndEdgeStatus = EnumNodeAndEdgeStatus = {}));
...
var _default = function _default() {
  _g.default.registerEdge('graphin-line', {
    ...
    setState: function setState(name, value, item) {
      ...
      var initStateStyle = (0, _util.deepMix)({}, this.options.status, model.style.status);
      ...
      try {
        Object.keys(initStateStyle).forEach(function (statusKey) {
          if (name === statusKey) {
            if (value) {
              (0, _utils.setStatusStyle)(shapes, initStateStyle[statusKey], parseAttr); // 匹配到status就改变
            } else {
              (0, _utils.setStatusStyle)(shapes, initialStyle, parseAttr); // 没匹配到就重置

              status.forEach(function (key) {
                // 如果cfg.status中还有其他状态，那就重新设置回来
                (0, _utils.setStatusStyle)(shapes, initStateStyle[key], parseAttr);
              });
            }
          }
        });
