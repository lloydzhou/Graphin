...
exports.getRelativeNodesType = exports.getMinDistanceNode = exports.getAvgNodePosition = exports.default = void 0;

var _index = _interopRequireDefault(require("../../utils/index"));

var _Vector = _interopRequireDefault(require("../force/Vector"));
...
var getRelativeNodesType = function getRelativeNodesType(nodes, nodeClusterBy) {
...
exports.getRelativeNodesType = getRelativeNodesType;
...
var getRelativeNodes = function getRelativeNodes(type, coreNode, edges) {
  ...
  relativeNodes = _index.default.uniqBy(relativeNodes, function (a, b) {
    return a.id === b.id;
  });
...
var getMinDistanceNode = function getMinDistanceNode(sameTypeNodes) {
...
exports.getMinDistanceNode = getMinDistanceNode;

var getAvgNodePosition = function getAvgNodePosition(nodes) {
  var totalNodes = new _Vector.default(0, 0);
  nodes.forEach(function (node) {
    totalNodes = totalNodes.add(new _Vector.default(node.x, node.y));
  }); // 获取均值向量
