...
export var setStatusStyle = function setStatusStyle(shapes, statusStyle, parseAttr) {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  if (!statusStyle) {
    return;
  }
...
export var convertSizeToWH = function convertSizeToWH(size) {
  if (!size) return [0, 0];
  var width = 0;
  var height = 0;
...
export var getLabelXYByPosition = function getLabelXYByPosition(cfg) {
  var label = cfg.label,
...
export var getBadgePosition = function getBadgePosition() {
